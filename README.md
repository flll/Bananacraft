...
| `voxel_lower_bound` | **12** | 区画が小さくても 1 voxel ≒ 1 Minecraft ブロックを保証する下限 |
...
- City Plan の区画が 10×10 程度なら `voxel_lower_bound = 12` で **concept art の 1 ブロック ≒ Minecraft の 1 ブロック**になります。
