...
[`tailscale-acl-snippet.json`](tailscale-acl-snippet.json) の `tagOwners` を [Tailscale Access controls](https://login.tailscale.com/admin/acls) に追加済みであること。
...
未設定の場合、ノードは tailnet に参加できません（管理者が Admin コンソールで確認）。
